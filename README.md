...
![Order Routing](./screenshots/02-live-routing-order-status-agent.png)
...
![Order Response](./screenshots/03-order-status-structured-response.png)
...
![Returns Response](./screenshots/04-returns-agent-step-by-step-response.png)
*Returns specialist delivering step-by-step return
initiation guide after orchestrator handoff*

### 5. Live Routing — FAQ Query
![FAQ Routing](./screenshots/05-live-routing-faq-agent.png)
